...
#   "generate" "--nixpkgs-path=throw \"pass in nixpkgs\"" "-f" "/nix/store/cjw1fpd26cxbmbi5pgdnm1d5gycgnv1j-cargo-src-armv6m-unknown-none-eabi/Cargo.toml"
...
rec {
  ...
  rootCrate = rec {
    packageId = "nixpkgs-sysroot-stub-crate";
  ...
  workspaceMembers = {
    "nixpkgs-sysroot-stub-crate" = rec {
      packageId = "nixpkgs-sysroot-stub-crate";
      build = internal.buildRustCrateWithFeatures {
        packageId = "nixpkgs-sysroot-stub-crate";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "nixpkgs-sysroot-stub-crate" = rec {
        crateName = "nixpkgs-sysroot-stub-crate";
        version = "0.0.0";
        edition = "2018";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../../../../../../nix/store/cjw1fpd26cxbmbi5pgdnm1d5gycgnv1j-cargo-src-armv6m-unknown-none-eabi; };
        authors = [
          "The Rust Project Developers"
        ];
        dependencies = [
