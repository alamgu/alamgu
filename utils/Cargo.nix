...
#   "generate" "--nixpkgs-path=throw \"pass in nixpkgs\""
  ...
  internal = rec {
    ...
    crates = {
      ...
      "clap 3.1.12" = rec {
        ...
        version = "3.1.12";
        edition = "2018";
        sha256 = "1ns6s6yiy96rri2mv87zdlm0s0nxrrqcifw7zlrmzz1a6hvpw5kw";
        dependencies = [
          {
            name = "atty";
            packageId = "atty";
