...
import (nixpkgs_src + "/pkgs/development/compilers/rust/default.nix") {
  rustcVersion = "1.53.0";
...
(builtins.removeAttrs args [ "fetchpatch" "pkgsBuildHost" "llvmPackages_11" "llvmPackages_12" "llvm_12" "nixpkgs_src"])
