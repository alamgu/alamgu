...
in ci // {
  ...
  // lib.mapAttrs' (n: lib.nameValuePair ("macos--nanos--" + n)) (ci."${a}".x86_64-darwin.perDevice.nanos)
  // lib.mapAttrs' (n: lib.nameValuePair ("macos--nanox--" + n)) (ci."${a}".x86_64-darwin.perDevice.nanox)
  // lib.mapAttrs' (n: lib.nameValuePair ("macos--nanosplus--" + n)) (ci."${a}".x86_64-darwin.perDevice.nanosplus))
